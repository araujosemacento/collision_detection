...
3. **Crie um Jogo Pong**: Com a colisão [Círculo/Retângulo](circle-rect) dominada, você já tem tudo o que é necessário para construir um jogo clássico de [**Pong**](https://pt.wikipedia.org/wiki/Pong)! Tente criar um exemplo simples com dois retângulos como raquetes e um circulo como a bola.
